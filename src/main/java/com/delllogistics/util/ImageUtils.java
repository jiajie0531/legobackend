...
public class ImageUtils {
     ...
     *            新的高度，小于1则忽略，按原图比例缩放
     */
    public static void resize(InputStream input, File destFile, int width, int height) throws Exception {
        resize(input, destFile, width, height, -1, -1);
    }
    /**
     * 重调图片尺寸
     *
     ...
     *            最大高度，限制目标图片高度，小于1则忽略此设置
     */
    public static void resize(InputStream input,  File destFile, int width,
                              int height, int maxWidth, int maxHeight) throws Exception {
        if (destFile.exists()) {
            destFile.delete();
        } else {
    ...
    public static void main(String[] args) throws Exception {
        File imgFile = new File("/Users/guangxingju/Desktop/Test.jpg");

        File thumbFile = new File("/Users/guangxingju/Desktop/Test100x100.jpg");


        ImageUtils.resize(imgFile, thumbFile, 300, 0);
